...
int main() {
    ...
    MAC target = read_mac_from_str("54:d6:a6:82:c5:01");
    MAC target2 = read_mac_from_str("54:d6:a6:82:c5:02");
    trame_ethernet t = creer_trame_vide(r.equipements[7], target2);
    trame_ethernet t2 = creer_trame_vide(r.equipements[5], target);
